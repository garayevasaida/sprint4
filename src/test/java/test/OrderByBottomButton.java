...
public class OrderByBottomButton {
    ...
    public void fullOrderTest() {
        ...
        WebElement bottomOrderButton = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(MainPage.BOTTOM_ORDER_BUTTON)));
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(OrderLastPage.CONFIRMED_ORDER_WINDOW)));
    ...
    private final String nameInput; private final String surnameInput; private final String addressInput; private final String stationNameInput;
    private final String phoneNumberInput; private final String dateOfDelivery; private final int rentalPeriod; private final String scooterColour; private final String comment;

    public OrderByBottomButton (String nameInput, String surnameInput, String addressInput, String stationNameInput, String phoneNumberInput, String dateOfDelivery, int rentalPeriod, String scooterColour, String comment) {
    ...
    public void tearDown() {
        // Закрваем браузер после завершения всех тестов
        driver.quit();
    }
}
